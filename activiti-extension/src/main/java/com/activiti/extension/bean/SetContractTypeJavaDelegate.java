...
public class SetContractTypeJavaDelegate implements JavaDelegate {
    ...
    public void setContractName(Expression contractName) {
        this.contractName = contractName;
    }

    public void setContractId(Expression contractId) {
        this.contractId = contractId;
    }

    public void setSecurityClassification(Expression securityClassification) {
